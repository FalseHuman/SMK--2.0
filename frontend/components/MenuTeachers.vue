<template>
    <div>
         <div class="list-group text-wrap block">
            <nuxt-link exact no-prefetch active-class="active" class="list-group-item list-group-item-action text-center" to="/teachers/info">Справочная информация</nuxt-link>
